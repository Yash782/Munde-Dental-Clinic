...
const Services = () => {
  const services: Service[] = [
    ...
    },
    {
      ...
      description: 'Teeth whitening, veneers, and other procedures to enhance your smile and confidence.',
    ...
    },
    {
      id: 4,
      title: 'Oral Surgery',
      description: 'Extractions, implants, and other surgical procedures performed with precision and care.',
      icon: <Heart size={32} className="text-emerald-500" />,
    },
    {
      id: 5,
      title: 'Periodontics',
      description: 'Treatment for gum disease and comprehensive care for the supporting structures of teeth.',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-xl mx-auto text-lg">
            We provide comprehensive dental care using state-of-the-art technology and techniques to ensure the best outcomes for our patients.
          </p>
        </div>
