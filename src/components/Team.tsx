...
const Team = () => {
  const teamMembers: TeamMember[] = [
    ...
    },
    {
      ...
      image: 'https://images.pexels.com/photos/5438504/pexels-photo-5438504.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    },
    {
      id: 3,
        ...
        <div className="mt-16 bg-gradient-to-r from-emerald-500 to-emerald-700 rounded-xl p-8 shadow-lg">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-2/3 mb-6 md:mb-0">
              <h3 className="text-2xl font-bold text-white mb-2">We're Always Welcoming New Patients</h3>
              <p className="text-emerald-100">
                Join our dental family and experience the difference quality dental care can make.
              </p>
            </div>
            <a 
              href="#contact" 
